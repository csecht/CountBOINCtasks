...
HIGHLIGHT_COLOR = 'gold1'  # Notices, compliments, highlight fg.
EMPHASIZE_COLOR = 'grey90'  # Lighter data label fg, use for grey-out.
DEEMPHASIZE_COLOR = 'grey60'  # Darker data label fg.
